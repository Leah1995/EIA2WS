...
(function (uno) {
    ...
    let cards = ["b0", "b1", "b1", "b1", "b2", "b2", "b2", "b3", "b3", "b3", "b4", "b4", "b4", "b5", "b5", "b6", "b6", "b6", "b7", "b7", "b7", "b8", "b8", "b8", "b9", "b9",
        ...
        "y0", "y1", "y1", "y2", "y2", "y2", "y3", "y3", "y4", "y4", "y4", "y5", "y5", "y6", "y6", "y6", "y7", "y7", "y8", "y8", "y8", "y9", "y9", "p2", "p2", "w", "w", "s", "s"];
    let bluecards = ["b0", "b1", "b1", "b1", "b2", "b2", "b2", "b3", "b3", "b3", "b4", "b4", "b4", "b5", "b5", "b5", "b6", "b6", "b7", "b7", "b8", "b8", "b8", "b9", "b9", "b9"];
    let greencards = ["g0", "g1", "g1", "g1", "g2", "g2", "g2", "g3", "g3", "g3", "g4", "g4", "g4", "g5", "g5", "g5", "g6", "g6", "g6", "g7", "g7", "g7", "g8", "g8", "g9", "g9", "g9"];
    let redcards = ["r0", "r1", "r1", "r1", "r1", "r2", "r2", "r2", "r3", "r3", "r4", "r4", "r4", "r5", "r5", "r6", "r6", "r6", "r7", "r7", "r8", "r8", "r8", "r9", "r9", "r9"];
    let yellowcards = ["y0", "y1", "y1", "y1", "y2", "y2", "y3", "y3", "y3", "y4", "y4", "y5", "y5", "y5", "y6", "y6", "y7", "y7", "y7", "y8", "y8", "y9", "y9", "y9"];
    let blackcards = ["plus 2", "plus 2", "wild", "wild", "skip", "skip", "<->", "<->"];
    let handcards = [];
    let filedcards = [];
    let deck = [];
    let cardNumber;
