...
//        drawBerg(300, 470);
        ...
        // Rodler
        function drawRodler1(_x: number, _y: number): void {
            // Kopf
            crc2.beginPath();
            ...
            // Körper
            crc2.beginPath();
            crc2.arc(_x + 92, _y + 370, 8, 3, 2 * Math.PI); // x, y, Größe
            crc2.fillStyle = "#04623B";
            crc2.fill();
            crc2.fillStyle = "#0BF393";
            crc2.fillRect(_x + 84, _y + 370, 15, 20); // Anfang, Höhe, Dicke, Länge
            // Bein
            crc2.beginPath();
        ...
        // Schlitten 1
        function drawSchlitten1(_x: number, _y: number): void {
            crc2.beginPath();
        ...
        // Rodler 2
        function drawRodler2(_x: number, _y: number): void {
            // Kopf
            crc2.beginPath();
            ...
            crc2.beginPath();
            crc2.fillStyle = "#F3370B";
            crc2.fillRect(_x + 28, _y + 352, 8, 15); // Anfang, Höhe, Dicke, Länge
            ...
            // Kragen
            crc2.beginPath();
            crc2.arc(_x + 32, _y + 352, 5, 3, 2 * Math.PI); // x, y, Größe
            crc2.fillStyle = "#F76A4B";
            crc2.fill();
        } // Ende function drawRodler

        // Schlitten 2
        function drawSchlitten2(_x: number, _y: number): void {
